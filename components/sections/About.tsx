import Link from 'next/link';
 ...
 export default function AboutSection() {
  return (
    <section 
      id="about" 
      className="w-full flex flex-col items-center justify-start relative z-10 bg-[#05060a] pt-32 pb-20 px-6 scroll-mt-20 min-h-screen"
    >
      ...
      {/* ========================================= */}
      {/* TOP LOGOS (Transparent, NO white box)       */}
      {/* ========================================= */}
  ...
  >
    <img
      ...
      className="h-20 w-auto object-contain cursor-pointer transition-transform duration-300 ease-in-out hover:scale-105 hover:brightness-110"
    />
  </a>
</div>
      ...
      <div className="max-w-4xl text-center mb-16 z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold text-white uppercase tracking-widest font-mono mb-6">
          System Overview
        </h1>
      ...
      <div className="w-full max-w-4xl z-10 mb-20">
        <div className="bg-black/80 border border-white/10 rounded-xl overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.8)]">
          ...
          {/* Terminal Content (Citations Removed) */}
          <div className="p-6 md:p-8 font-mono text-sm md:text-base leading-relaxed text-gray-300">
            <p className="mb-4">
              <span className="text-[#50fa7b] font-bold">root@codeforcause:~$</span> cat mission_statement.txt
            </p>
            <p className="pl-4 border-l-2 border-white/10 text-gray-400 mb-4">
            ...
            <p className="pl-4 border-l-2 border-white/10 text-gray-400">
      ...
      {/* ========================================= */}
      {/* VISION STATEMENT (Glowing Banner)           */}
      {/* ========================================= */}
      <div className="w-full max-w-6xl z-10 mb-24 px-6">
        <div className="relative bg-gradient-to-r from-[#1a73e8]/20 to-[#00d2ff]/20 border border-[#00d2ff]/30 rounded-3xl p-8 md:p-12 text-center overflow-hidden hover:border-[#00d2ff]/60 transition-colors duration-500">
          
          <svg className="absolute -right-10 -bottom-10 w-64 h-64 text-[#00d2ff] opacity-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>

          <h2 className="text-[#00d2ff] font-mono text-sm tracking-[0.3em] uppercase mb-4 font-bold">
            Our Vision
          </h2>
          <p className="text-xl md:text-3xl font-bold text-white leading-relaxed max-w-4xl mx-auto relative z-10">
      ...
      {/* CORE FOCUS AREAS                            */}
      {/* ========================================= */}
      <div className="w-full max-w-6xl z-10 mb-24">
        
        <div className="text-center mb-12">
          <h2 className="text-[#50fa7b] font-mono text-sm tracking-[0.3em] uppercase mb-4 font-bold">
            Execution Parameters
          </h2>
          <h3 className="text-3xl md:text-5xl font-bold text-white tracking-wide">Technical Domains</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          
          {/* Software Focus */}
          <div className="bg-[#0a0c10] border border-white/5 rounded-3xl p-8 hover:-translate-y-2 hover:border-[#1a73e8] hover:shadow-[0_0_30px_rgba(26,115,232,0.15)] transition-all duration-300">
            <div className="w-14 h-14 bg-[#1a73e8]/20 rounded-xl flex items-center justify-center text-[#1a73e8] mb-6 border border-[#1a73e8]/30">
            ...
            <h4 className="text-xl font-bold text-white mb-3">Software Architecture</h4>
          ...
          {/* Hardware Focus */}
          <div className="bg-[#0a0c10] border border-white/5 rounded-3xl p-8 hover:-translate-y-2 hover:border-yellow-400 hover:shadow-[0_0_30px_rgba(250,204,21,0.15)] transition-all duration-300">
            <div className="w-14 h-14 bg-yellow-400/20 rounded-xl flex items-center justify-center text-yellow-400 mb-6 border border-yellow-400/30">
            ...
            <h4 className="text-xl font-bold text-white mb-3">Embedded Systems</h4>
            <p className="text-gray-400 text-sm leading-relaxed">
          ...
          {/* IoT Focus */}
          <div className="bg-[#0a0c10] border border-white/5 rounded-3xl p-8 hover:-translate-y-2 hover:border-[#50fa7b] hover:shadow-[0_0_30px_rgba(80,250,123,0.15)] transition-all duration-300">
            <div className="w-14 h-14 bg-[#50fa7b]/20 rounded-xl flex items-center justify-center text-[#50fa7b] mb-6 border border-[#50fa7b]/30">
            ...
            <h4 className="text-xl font-bold text-white mb-3">Internet of Things (IoT)</h4>
            <p className="text-gray-400 text-sm leading-relaxed">
      ...
      {/* ========================================= */}
      {/* ORIGIN (Department Block)                   */}
      {/* ========================================= */}
      <div className="w-full max-w-4xl z-10 mb-20 text-center bg-white/5 border border-white/10 rounded-3xl p-10 backdrop-blur-md">
        <p className="text-gray-400 text-sm font-mono mb-6 uppercase tracking-[0.2em]">Operating Out Of</p>
        <h3 className="text-2xl md:text-4xl font-bold text-white mb-2">V. T. Patel Department of ECE</h3>
        <p className="text-lg text-[#1a73e8] font-mono mb-8">Chandubhai S. Patel Institute of Technology, CHARUSAT</p>
        ...
        <a 
          ...
          className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#1a73e8] text-white rounded-xl font-bold text-lg hover:bg-white hover:text-[#05060a] shadow-[0_0_20px_rgba(26,115,232,0.4)] transition-all duration-300 cursor-none"
        >
